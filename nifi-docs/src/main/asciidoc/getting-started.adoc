...
- *PutSQSExtended*: Uses Amazon SQS Extended Client Library to send the contents of FlowFiles larger than 256K as messages to the Amazon Simple Queuing Service (SQS)
